...
public enum Server {
    ...
    static {
        GOOGLE_APIS.value = "Google APIs";
        MAPS_APIS.value = "Maps APIs";
        ROADS_APIS.value = "Roads APIs";

        valueMap.put("Google APIs", GOOGLE_APIS);
        valueMap.put("Maps APIs", MAPS_APIS);
        valueMap.put("Roads APIs", ROADS_APIS);
    }
